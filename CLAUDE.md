...
**YOU ARE IN: `budget_tracker/polecats/rictus/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/budget_tracker/` (rig root) or other directories

```bash
pwd  # Should show .../polecats/rictus
```
...
**Your mail address:** `budget_tracker/polecats/rictus`
**Your rig:** budget_tracker
**Your Witness:** `budget_tracker/witness`
...
1. Announce: "Polecat rictus, checking in."
...
| Ask Witness for help | `gt mail send budget_tracker/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`budget_tracker/witness`) when:
...
```bash
gt mail send budget_tracker/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
